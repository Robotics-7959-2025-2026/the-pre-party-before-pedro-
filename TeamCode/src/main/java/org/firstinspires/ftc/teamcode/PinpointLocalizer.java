...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -818.3909227464371; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1269.2928653347524; // x position of the perpendicular encoder (in tick units)
    }
